...
{ 
	...
	wp_register_script( 'elp-widget', ELP_URL . 'widget/widget.js', '', '', true );
	wp_enqueue_script( 'elp-widget' );
	$elp_script_params = array(
		'elp_widget_emailempty' => _x( '1Please enter email address.', 'elp-widget-script', 'email-posts-to-subscribers' ),
		'elp_widget_emailvalid' => _x( '2Please provide a valid email address.', 'elp-widget-script', 'email-posts-to-subscribers' ),
	);
	wp_localize_script( 'elp-widget', 'elp_widget_script', $elp_script_params );
}
?>
<div>
	<?php if( $elp_desc <> "" ) { ?>
