...
* Get the [Nifty Newsletters Premium Version](http://solaplugins.com/plugins/sola-newsletters/?utm_source=wordpress&utm_medium=click&utm_campaign=readme) now
...
We have created an incredibly easy to use newsletter editor which helps you create simple to advanced newsletters using a drag and drop interface.

* Click on Newsletters in your left navigation menu
* Click on the "New campaign" button at the top of the page
...
* Ensure that all your settings are correct and then press "Send now" or "Schedule". Your newsletter will now be queued and will be sent according to the email settings you have set in "Newsletter->Settings->Email Settings" 
