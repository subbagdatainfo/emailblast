							...
							<div id="ux_div_author_roles">
								...
								<div class="table-margin-top">
									...
									<thead>
										<tr>
											<th style="width: 40% !important;">
												<input type="checkbox" name="ux_chk_full_control_author" id="ux_chk_full_control_author" value="1" onclick="full_control_function_mail_bank(this, 'ux_div_author_roles');" <?php echo '1' === isset( $author ) && $author[0] ? 'checked = checked' : ''; ?>>
												<?php echo esc_attr( $mb_roles_capabilities_full_control ); ?>
											</th>
										</tr>
									</thead>
									<tbody>
										...
										<tr>
											...
											<td>
												<input type="checkbox" name="ux_chk_settings_author" id="ux_chk_settings_author" value="1" <?php echo isset( $author ) && '1' === $author[5] ? 'checked = checked' : ''; ?>>
												<?php echo esc_attr( $mb_settings ); ?>
											</td>
											<td>
							...
							<div id="ux_div_editor_roles">
								...
								<div class="table-margin-top">
									...
									<thead>
										<tr>
											<th style="width: 40% !important;">
												<input type="checkbox" name="ux_chk_full_control_editor" id="ux_chk_full_control_editor" value="1" onclick="full_control_function_mail_bank(this, 'ux_div_editor_roles');" <?php echo '1' === isset( $editor ) && $editor[0] ? 'checked = checked' : ''; ?>>
												<?php echo esc_attr( $mb_roles_capabilities_full_control ); ?>
											</th>
										</tr>
									</thead>
									<tbody>
										...
										<tr>
											...
											<td>
												<input type="checkbox" name="ux_chk_settings_editor" id="ux_chk_settings_editor" value="1" <?php echo isset( $editor ) && '1' === $editor[5] ? 'checked = checked' : ''; ?>>
												<?php echo esc_attr( $mb_settings ); ?>
											</td>
											<td>
												<input type="checkbox" name="ux_chk_roles_and_capabilities_editor" id="ux_chk_roles_and_capabilities_editor" value="1" <?php echo isset( $editor ) && '1' === $editor[6] ? 'checked = checked' : ''; ?>>
												<?php echo esc_attr( $mb_roles_and_capabilities ); ?>
											</td>
										</tr>
										<tr>
							...
							<div id="ux_div_contributor_roles">
								...
								<div class="table-margin-top">
									...
									<thead>
										<tr>
											<th style="width: 40% !important;">
												<input type="checkbox" name="ux_chk_full_control_contributor" id="ux_chk_full_control_contributor" value="1" onclick="full_control_function_mail_bank(this, 'ux_div_contributor_roles');" <?php echo '1' === isset( $contributor ) && $contributor[0] ? 'checked = checked' : ''; ?>>
												<?php echo esc_attr( $mb_roles_capabilities_full_control ); ?>
											</th>
										</tr>
									</thead>
									<tbody>
										...
										<tr>
											...
											<td>
												<input type="checkbox" name="ux_chk_settings_contributor" id="ux_chk_settings_contributor" value="1" <?php echo isset( $contributor ) && '1' === $contributor[5] ? 'checked = checked' : ''; ?>>
												<?php echo esc_attr( $mb_settings ); ?>
											</td>
											<td>
							...
							<div id="ux_div_subscriber_roles">
								...
								<div class="table-margin-top">
									...
									<thead>
										<tr>
											<th style="width: 40% !important;">
												<input type="checkbox" name="ux_chk_full_control_subscriber" id="ux_chk_full_control_subscriber" value="1" onclick="full_control_function_mail_bank(this, 'ux_div_subscriber_roles');" <?php echo '1' === isset( $subscriber ) && $subscriber[0] ? 'checked = checked' : ''; ?>>
												<?php echo esc_attr( $mb_roles_capabilities_full_control ); ?>
											</th>
										</tr>
									</thead>
									<tbody>
										...
										<tr>
											...
											<td>
												<input type="checkbox" name="ux_chk_settings_subscriber" id="ux_chk_settings_subscriber" value="1" <?php echo isset( $subscriber ) && '1' === $subscriber[5] ? 'checked = checked' : ''; ?>>
												<?php echo esc_attr( $mb_settings ); ?>
											</td>
											<td>
							...
							<div id="ux_div_other_privileges_roles">
								...
								<div class="table-margin-top">
									...
									<thead>
										<tr>
											<th style="width: 40% !important;">
												<input type="checkbox" name="ux_chk_full_control_other_privileges_roles" id="ux_chk_full_control_other_privileges_roles" value="1" onclick="full_control_function_mail_bank(this, 'ux_div_other_privileges_roles');" <?php echo '1' === isset( $other_privileges ) && $other_privileges[0] ? 'checked = checked' : ''; ?>>
												<?php echo esc_attr( $mb_roles_capabilities_full_control ); ?>
											</th>
										</tr>
									</thead>
									<tbody>
										...
										<tr>
											...
											<td>
												<input type="checkbox" name="ux_chk_settings_others" id="ux_chk_settings_others" value="1" <?php echo isset( $other_privileges ) && '1' === $other_privileges[5] ? 'checked = checked' : ''; ?>>
												<?php echo esc_attr( $mb_settings ); ?>
											</td>
											<td>
												<input type="checkbox" name="ux_chk_roles_and_capabilities_others" id="ux_chk_roles_and_capabilities_others" value="1" <?php echo isset( $other_privileges ) && '1' === $other_privileges[6] ? 'checked = checked' : ''; ?>>
												<?php echo esc_attr( $mb_roles_and_capabilities ); ?>
											</td>
										</tr>
										<tr>
											<td>
												<input type="checkbox" name="ux_chk_system_information_others" id="ux_chk_system_information_others" value="1" <?php echo isset( $other_privileges ) && '1' === $other_privileges[7] ? 'checked = checked' : ''; ?>>
												<?php echo esc_attr( $mb_system_information ); ?>
											</td>
											<td>
											</td>
