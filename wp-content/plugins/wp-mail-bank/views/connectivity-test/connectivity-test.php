...
if ( ! is_user_logged_in() ) {
	...
	if ( ! $access_granted ) {
		return;
	} elseif ( CONECTIVITY_TEST_EMAIL_MAIL_BANK === '1' ) {
				...
				<div class="portlet-body form">
					<form id="ux_frm_settings">
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" name="ux_txt_conn_search" id="ux_txt_conn_search" value="" placeholder="<?php echo esc_attr( $mb_localhost ); ?>">
							<i class='controls-description'><?php echo esc_attr( $mb_mail_server_tooltip ); ?></i>
						</div>
						<div class="form-actions">
							<div class="pull-right">
								<input type="submit" class="btn vivid-green" name="ux_btn_begin_test" id="ux_btn_begin_test" value="<?php echo esc_attr( $mb_begin_test ); ?>">
							</div>
						</div>
