						...
						<div class="custom-form-body">
							...
							<table class="table table-striped table-bordered table-hover" >
								...
								<tr>
									...
									<td>
										<span>
											<?php echo esc_html( isset( $_SERVER['SERVER_SOFTWARE'] ) ? esc_attr( wp_unslash( Filter_input( INPUT_SERVER, 'SERVER_SOFTWARE' ) ) ) : '' );// Input var okay. ?>
										</span>
									</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td>
											<span>
												<?php echo intval( ini_get( 'max_input_vars' ) ); ?>
											</span>
										</td>
									</tr>
									<tr>
									...
									foreach ( $active_plugins as $plugin ) {
										...
										if ( ! empty( $plugin_data['Name'] ) ) {
											...
											if ( ! empty( $plugin_data['PluginURI'] ) ) {
												$plugin_name = '<tr><td><strong>' . $plugin_name . ' :</strong></td><td><span>' . $plugin_data['Author'] . '<br/> Version ' . $plugin_data['Version'] . $version_string . '</span></td></tr>';
											}
