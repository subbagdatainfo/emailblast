		...
		if ( isset( $_REQUEST['page'] ) ) {// WPCS: Input var okay, CSRF ok.
			switch ( $page_url ) {
				case 'mb_mail_bank_welcome_page':
					...
					{
						if( ( jQuery("#ux_txt_email_address_notifications").val() ===  "" || jQuery("#ux_chk_gdpr_compliance_agree").prop('checked') === false ) && type !== "skip")
						{
							...
							if( jQuery("#ux_chk_gdpr_compliance_agree").prop('checked') === false )
							{
								jQuery("#ux_chk_validation_gdpr_mail_bank").css({"display":'','color':'red'});
								jQuery("#gdpr_agree_text_mail_bank").css('color','red');
							}
							else {
								jQuery("#ux_chk_validation_gdpr_mail_bank").css( 'display','none' );
								jQuery("#gdpr_agree_text_mail_bank").css('color','#444');
							}
						}
						else
						{
							jQuery("#ux_chk_validation_gdpr_mail_bank, #ux_txt_validation_gdpr_mail_bank").css( 'display','none' );
							jQuery("#ux_txt_email_address_notifications").css("border-color","#ddd");
							jQuery("#gdpr_agree_text_mail_bank").css('color','#444');
